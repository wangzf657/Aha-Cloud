package com.aha.common.log.aspect;
...
import com.aha.common.log.enums.BusinessStatus;
import com.aha.common.log.filter.PropertyPreExcludeFilter;
import com.aha.common.log.service.AsyncLogService;
    ...
    protected void handleLog(final JoinPoint joinPoint, Log controllerLog,
        ...
        try {
            ...
            if (e != null) {
                ...
                operLog.setErrorMsg(StringUtils.substring(e.getMessage(), 0,
                        2000));
            }
            // 设置方法名称
