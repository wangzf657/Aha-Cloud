package com.aha.common.security.interceptor;
...
public class HeaderInterceptor implements AsyncHandlerInterceptor {
    ...
    public boolean preHandle(HttpServletRequest request,
        ...
        SecurityContextHolder.setUserId(ServletUtils.getHeader(request,
                SecurityConstants.DETAILS_USER_ID));
        SecurityContextHolder.setUserName(ServletUtils.getHeader(request,
