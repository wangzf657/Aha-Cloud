...
import com.aha.common.security.utils.DictUtils;
import com.aha.system.api.domain.SysDictData;
import com.aha.system.api.domain.SysDictType;
import com.aha.system.mapper.SysDictDataMapper;
import com.aha.system.mapper.SysDictTypeMapper;
import com.aha.system.service.ISysDictTypeService;
...
public class SysDictTypeServiceImpl implements ISysDictTypeService {
    ...
    public void loadingDictCache() {
        ...
        for (Map.Entry<String, List<SysDictData>> entry :
                dictDataMap.entrySet()) {
    ...
    public int updateDictType(SysDictType dict) {
        ...
        dictDataMapper.updateDictDataType(oldDict.getDictType(),
                dict.getDictType());
    ...
    public boolean checkDictTypeUnique(SysDictType dict) {
        Long dictId = StringUtils.isNull(dict.getDictId()) ? -1L :
                dict.getDictId();
        SysDictType dictType =
                dictTypeMapper.checkDictTypeUnique(dict.getDictType());
