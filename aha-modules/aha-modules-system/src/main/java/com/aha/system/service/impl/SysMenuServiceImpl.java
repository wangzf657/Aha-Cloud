...
import com.aha.system.domain.vo.MetaVo;
import com.aha.system.domain.vo.RouterVo;
import com.aha.system.domain.vo.TreeSelect;
import com.aha.system.mapper.SysMenuMapper;
import com.aha.system.mapper.SysRoleMapper;
import com.aha.system.mapper.SysRoleMenuMapper;
import com.aha.system.service.ISysMenuService;
...
public class SysMenuServiceImpl implements ISysMenuService {
    ...
    public List<RouterVo> buildMenus(List<SysMenu> menus) {
        ...
        for (SysMenu menu : menus) {
            ...
            if (StringUtils.isNotEmpty(cMenus) && UserConstants.TYPE_DIR.equals(menu.getMenuType())) {
                ...
                children.setName(getRouteName(menu.getRouteName(),
                        menu.getPath()));
                children.setMeta(new MetaVo(menu.getMenuName(),
                        menu.getIcon(), StringUtils.equals("1",
                        menu.getIsCache()), menu.getPath()));
    ...
    public boolean checkMenuNameUnique(SysMenu menu) {
        Long menuId = StringUtils.isNull(menu.getMenuId()) ? -1L :
                menu.getMenuId();
    ...
    public String innerLinkReplaceEach(String path) {
        return StringUtils.replaceEach(path, new String[]{Constants.HTTP,
                Constants.HTTPS, Constants.WWW, ".", ":"}, new String[]{"",
                "", "", "/", "/"});
    }
}
