package com.aha.job.controller;
...
import com.aha.job.service.ISysJobService;
import com.aha.job.util.CronUtils;
import com.aha.job.util.ScheduleUtils;
...
public class SysJobController extends BaseController {
    ...
    public AjaxResult add(@RequestBody SysJob job) throws SchedulerException,
        ...
        } else if (StringUtils.containsIgnoreCase(job.getInvokeTarget(),
