package com.aha.file.utils;

import com.aha.common.core.exception.file.FileException;
import com.aha.common.core.exception.file.FileNameLengthLimitExceededException;
import com.aha.common.core.exception.file.FileSizeLimitExceededException;
import com.aha.common.core.exception.file.InvalidExtensionException;
...
import com.aha.common.core.utils.file.MimeTypeUtils;
import com.aha.common.core.utils.uuid.Seq;
...
public class FileUploadUtils {
    ...
    public static final String upload(String baseDir, MultipartFile file,
        ...
        int fileNamelength =
                Objects.requireNonNull(file.getOriginalFilename()).length();
    ...
    private static final File getAbsoluteFile(String uploadDir,
    ...
    public static final void assertAllowed(MultipartFile file,
        ...
        if (allowedExtension != null && !isAllowedExtension(extension,
                allowedExtension)) {
            if (allowedExtension == MimeTypeUtils.IMAGE_EXTENSION) {
                ...
                throw new InvalidExtensionException(allowedExtension,
                        extension, fileName);
            }
        }
    }
